# Generated by Powerlevel10k configuration wizard on 2024-12-27 at 12:06 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=63
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=62
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=63
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#ffffff}' # white foreground
    local      clean='%F{#ffffff}' # white foreground
    local   modified='%F{#ffffff}' # white foreground
    local  untracked='%F{#ffffff}' # white foreground
